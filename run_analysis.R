...
write.table(X_all, file = "data_full.txt", row.names = FALSE)
...
## saves dataset
write.table(X_clean, file = 'tidy_data.txt', row.names = FALSE)
...
## write tidy dataset
write.table(X_tidy, file = 'tidy_means.txt', row.names = FALSE)
Write(codebook(X_tidy), 'Codebook.txt')